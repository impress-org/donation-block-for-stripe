 ...
 * @property \GiveDonationBlock\Strauss\Stripe\StripeObject[] $data
 */
class Collection extends StripeObject implements \Countable, \IteratorAggregate
{
    ...
    public function all($params = null, $opts = null)
    {
        ...
        if (!($obj instanceof \Stripe\Collection)) {
            throw new \GiveDonationBlock\Strauss\Stripe\Exception\UnexpectedValueException(
                'Expected type ' . \GiveDonationBlock\Strauss\Stripe\Collection::class . ', got "' . \get_class($obj) . '" instead.'
            );
        }
     ...
     *
     * @return null|\GiveDonationBlock\Strauss\Stripe\StripeObject
     */
