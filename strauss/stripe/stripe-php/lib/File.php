 ...
 * @property null|\GiveDonationBlock\Strauss\Stripe\Collection $links A list of <a href="https://stripe.com/docs/api#file_links">file links</a> that point at this file.
...
class File extends ApiResource
{
     ...
     *
     * @return \GiveDonationBlock\Strauss\Stripe\File the created file
     */
    public static function create($params = null, $opts = null)
    {
        ...
        $flatParams = \array_column(\GiveDonationBlock\Strauss\Stripe\Util\Util::flattenParams($params), 1, 0);
