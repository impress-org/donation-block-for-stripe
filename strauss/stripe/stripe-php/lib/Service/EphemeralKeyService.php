...
class EphemeralKeyService extends \GiveDonationBlock\Strauss\Stripe\Service\AbstractService
{
    /**
     ...
     *
     * @return \GiveDonationBlock\Strauss\Stripe\EphemeralKey
     *
     * @license MIT
    ...
    public function create($params = null, $opts = null)
    {
        if (!$opts || !isset($opts['stripe_version'])) {
            throw new \GiveDonationBlock\Strauss\Stripe\Exception\InvalidArgumentException('stripe_version must be specified to create an ephemeral key');
        }
