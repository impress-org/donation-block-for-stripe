...
class ChargeService extends \GiveDonationBlock\Strauss\Stripe\Service\AbstractService
{
    /**
     ...
     * @throws \GiveDonationBlock\Strauss\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \GiveDonationBlock\Strauss\Stripe\Charge
     */
     ...
     * will occur as if in live mode. (GiveDonationBlock\Strauss\Stripe assumes that the charge would have
