 ...
 * @property string|\GiveDonationBlock\Strauss\Stripe\BillingPortal\Configuration $configuration The configuration used by this session, describing the features available.
