 ...
 * @property string|\GiveDonationBlock\Strauss\Stripe\Customer $customer ID of the customer.
 * @property null|string|\GiveDonationBlock\Strauss\Stripe\CustomerBalanceTransaction $customer_balance_transaction Customer balance transaction related to this credit note.
 * @property int $discount_amount The integer amount in %s representing the total amount of discount that was credited.
 * @property \GiveDonationBlock\Strauss\Stripe\StripeObject[] $discount_amounts The aggregate amounts calculated per discount for all line items.
 * @property string|\GiveDonationBlock\Strauss\Stripe\Invoice $invoice ID of the invoice.
 * @property \GiveDonationBlock\Strauss\Stripe\Collection $lines Line items that make up the credit note
 ...
 * @property null|string|\GiveDonationBlock\Strauss\Stripe\Refund $refund Refund related to this credit note.
 ...
 * @property \GiveDonationBlock\Strauss\Stripe\StripeObject[] $tax_amounts The aggregate amounts calculated per tax rate for all line items.
...
class CreditNote extends ApiResource
{
     ...
     *
     * @return \GiveDonationBlock\Strauss\Stripe\CreditNote the previewed credit note
     */
     ...
     * @throws \GiveDonationBlock\Strauss\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \GiveDonationBlock\Strauss\Stripe\CreditNote the voided credit note
     */
     ...
     * @throws \GiveDonationBlock\Strauss\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \GiveDonationBlock\Strauss\Stripe\Collection the list of credit note line items
     */
