...
namespace GiveDonationBlock\Strauss\Stripe\Radar;
 ...
 * @property string|\GiveDonationBlock\Strauss\Stripe\Charge $charge ID of the charge this early fraud warning is for, optionally expanded.
 ...
 * @property string|\GiveDonationBlock\Strauss\Stripe\PaymentIntent $payment_intent ID of the Payment Intent this early fraud warning is for, optionally expanded.
 *
 * @license MIT
 * Modified by Jason Adams on 03-March-2022 using Strauss.
 * @see https://github.com/BrianHenryIE/strauss
 */
class EarlyFraudWarning extends \GiveDonationBlock\Strauss\Stripe\ApiResource
{
