 ...
 * @property null|\GiveDonationBlock\Strauss\Stripe\StripeObject $billing_thresholds Define thresholds at which an invoice will be sent, and the related subscription advanced to a new billing period
 ...
 * @property null|\GiveDonationBlock\Strauss\Stripe\TaxRate[] $tax_rates The tax rates which apply to this <code>subscription_item</code>. When set, the <code>default_tax_rates</code> on the subscription do not apply to this <code>subscription_item</code>.
 *
 * @license MIT
...
class SubscriptionItem extends ApiResource
{
     ...
     *
     * @return \GiveDonationBlock\Strauss\Stripe\UsageRecord
     */
     ...
     * @throws \GiveDonationBlock\Strauss\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \GiveDonationBlock\Strauss\Stripe\Collection the list of usage record summaries
     */
