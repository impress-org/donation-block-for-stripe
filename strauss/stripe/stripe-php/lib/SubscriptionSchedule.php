 ...
 * @property null|\GiveDonationBlock\Strauss\Stripe\StripeObject $current_phase Object representing the start and end dates for the current phase of the subscription schedule, if it is <code>active</code>.
 * @property string|\GiveDonationBlock\Strauss\Stripe\Customer $customer ID of the customer who owns the subscription schedule.
 * @property \GiveDonationBlock\Strauss\Stripe\StripeObject $default_settings
 ...
 * @property \GiveDonationBlock\Strauss\Stripe\StripeObject[] $phases Configuration for the subscription schedule's phases.
 ...
 * @property null|string|\GiveDonationBlock\Strauss\Stripe\Subscription $subscription ID of the subscription managed by the subscription schedule.
 *
 * @license MIT
...
class SubscriptionSchedule extends ApiResource
{
     ...
     *
     * @return \GiveDonationBlock\Strauss\Stripe\SubscriptionSchedule the canceled subscription schedule
     */
     ...
     * @throws \GiveDonationBlock\Strauss\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \GiveDonationBlock\Strauss\Stripe\SubscriptionSchedule the released subscription schedule
     */
