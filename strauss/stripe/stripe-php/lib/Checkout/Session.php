...
namespace GiveDonationBlock\Strauss\Stripe\Checkout;
 ...
 * @property null|\GiveDonationBlock\Strauss\Stripe\StripeObject $after_expiration When set, provides configuration for actions to take if this Checkout Session expires.
 ...
 * @property null|\GiveDonationBlock\Strauss\Stripe\StripeObject $consent Results of <code>consent_collection</code> for this session.
 * @property null|\GiveDonationBlock\Strauss\Stripe\StripeObject $consent_collection When set, provides configuration for the Checkout Session to gather active consent from customers.
 * @property null|string $currency Three-letter <a href="https://www.iso.org/iso-4217-currency-codes.html">ISO currency code</a>, in lowercase. Must be a <a href="https://stripe.com/docs/currencies">supported currency</a>.
 * @property null|string|\GiveDonationBlock\Strauss\Stripe\Customer $customer The ID of the customer for this Session. For Checkout Sessions in <code>payment</code> or <code>subscription</code> mode, Checkout will create a new customer object based on information provided during the payment flow unless an existing customer was provided when the Session was created.
 ...
 * @property null|\GiveDonationBlock\Strauss\Stripe\StripeObject $customer_details The customer details including the customer's tax exempt status and the customer's tax IDs. Only present on Sessions in <code>payment</code> or <code>subscription</code> mode.
 ...
 * @property \GiveDonationBlock\Strauss\Stripe\Collection $line_items The line items purchased by the customer.
 ...
 * @property null|string|\GiveDonationBlock\Strauss\Stripe\PaymentIntent $payment_intent The ID of the PaymentIntent for Checkout Sessions in <code>payment</code> mode.
 * @property null|string|\GiveDonationBlock\Strauss\Stripe\PaymentLink $payment_link The ID of the Payment Link that created this Session.
 * @property null|\GiveDonationBlock\Strauss\Stripe\StripeObject $payment_method_options Payment-method-specific configuration for the PaymentIntent or SetupIntent of this CheckoutSession.
 ...
 * @property \GiveDonationBlock\Strauss\Stripe\StripeObject $phone_number_collection
 * @property null|string $recovered_from The ID of the original expired Checkout Session that triggered the recovery flow.
 * @property null|string|\GiveDonationBlock\Strauss\Stripe\SetupIntent $setup_intent The ID of the SetupIntent for Checkout Sessions in <code>setup</code> mode.
 * @property null|\GiveDonationBlock\Strauss\Stripe\StripeObject $shipping Shipping information for this Checkout Session.
 * @property null|\GiveDonationBlock\Strauss\Stripe\StripeObject $shipping_address_collection When set, provides configuration for Checkout to collect a shipping address from a customer.
 * @property \GiveDonationBlock\Strauss\Stripe\StripeObject[] $shipping_options The shipping rate options applied to this Session.
 * @property null|string|\GiveDonationBlock\Strauss\Stripe\ShippingRate $shipping_rate The ID of the ShippingRate for Checkout Sessions in <code>payment</code> mode.
 ...
 * @property null|string|\GiveDonationBlock\Strauss\Stripe\Subscription $subscription The ID of the subscription for Checkout Sessions in <code>subscription</code> mode.
 ...
 * @property \GiveDonationBlock\Strauss\Stripe\StripeObject $tax_id_collection
 * @property null|\GiveDonationBlock\Strauss\Stripe\StripeObject $total_details Tax and discount details for the computed total amount.
 ...
 */
class Session extends \GiveDonationBlock\Strauss\Stripe\ApiResource
{
    const OBJECT_NAME = 'checkout.session';

    use \GiveDonationBlock\Strauss\Stripe\ApiOperations\All;
    use \GiveDonationBlock\Strauss\Stripe\ApiOperations\Create;
    use \GiveDonationBlock\Strauss\Stripe\ApiOperations\NestedResource;
     ...
     *
     * @return \GiveDonationBlock\Strauss\Stripe\Checkout\Session the expired session
     */
     ...
     * @throws \GiveDonationBlock\Strauss\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \GiveDonationBlock\Strauss\Stripe\Collection the list of items
     */
