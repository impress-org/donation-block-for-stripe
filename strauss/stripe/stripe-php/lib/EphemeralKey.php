...
class EphemeralKey extends ApiResource
{
     ...
     *
     * @throws \GiveDonationBlock\Strauss\Stripe\Exception\InvalidArgumentException if stripe_version is missing
     * @throws \GiveDonationBlock\Strauss\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \GiveDonationBlock\Strauss\Stripe\EphemeralKey the created key
     */
