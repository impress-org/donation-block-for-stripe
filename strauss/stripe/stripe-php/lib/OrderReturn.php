 ...
 * @property \GiveDonationBlock\Strauss\Stripe\OrderItem[] $items The items included in this order return.
 * @property bool $livemode Has the value <code>true</code> if the object exists in live mode or the value <code>false</code> if the object exists in test mode.
 * @property null|string|\GiveDonationBlock\Strauss\Stripe\Order $order The order that this return includes items from.
 * @property null|string|\GiveDonationBlock\Strauss\Stripe\Refund $refund The ID of the refund issued for this return.
 *
 * @license MIT
