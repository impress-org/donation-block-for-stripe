 ...
 * @property null|string|\GiveDonationBlock\Strauss\Stripe\StripeObject $application ID of the Connect application that created the SetupIntent.
 ...
 * @property null|\GiveDonationBlock\Strauss\Stripe\ErrorObject $last_setup_error The error encountered in the previous SetupIntent confirmation.
 * @property null|string|\GiveDonationBlock\Strauss\Stripe\SetupAttempt $latest_attempt The most recent SetupAttempt for this SetupIntent.
 * @property bool $livemode Has the value <code>true</code> if the object exists in live mode or the value <code>false</code> if the object exists in test mode.
 * @property null|string|\GiveDonationBlock\Strauss\Stripe\Mandate $mandate ID of the multi use Mandate generated by the SetupIntent.
 ...
 * @property null|\GiveDonationBlock\Strauss\Stripe\StripeObject $next_action If present, this property tells you what actions you need to take in order for your customer to continue payment setup.
 * @property null|string|\GiveDonationBlock\Strauss\Stripe\Account $on_behalf_of The account (if any) for which the setup is intended.
 * @property null|string|\GiveDonationBlock\Strauss\Stripe\PaymentMethod $payment_method ID of the payment method used with this SetupIntent.
 * @property null|\GiveDonationBlock\Strauss\Stripe\StripeObject $payment_method_options Payment-method-specific configuration for this SetupIntent.
 ...
 * @property null|string|\GiveDonationBlock\Strauss\Stripe\Mandate $single_use_mandate ID of the single_use Mandate generated by the SetupIntent.
...
class SetupIntent extends ApiResource
{
     ...
     *
     * @return \GiveDonationBlock\Strauss\Stripe\SetupIntent the canceled setup intent
     */
     ...
     * @throws \GiveDonationBlock\Strauss\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \GiveDonationBlock\Strauss\Stripe\SetupIntent the confirmed setup intent
     */
