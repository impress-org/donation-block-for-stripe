...
class BaseStripeClient implements StripeClientInterface, StripeStreamingClientInterface
{
    ...
    /** @var \GiveDonationBlock\Strauss\Stripe\Util\RequestOptions */
    private $defaultOpts;
    ...
    public function __construct($config = [])
    {
        if (\is_string($config)) {
            ...
            throw new \GiveDonationBlock\Strauss\Stripe\Exception\InvalidArgumentException('$config must be a string or an array');
        }
        ...
        $this->defaultOpts = \GiveDonationBlock\Strauss\Stripe\Util\RequestOptions::parse([
    ...
    public function request($method, $path, $params, $opts)
    {
        ...
        $requestor = new \GiveDonationBlock\Strauss\Stripe\ApiRequestor($this->apiKeyForRequest($opts), $baseUrl);
     ...
     * @param array|\GiveDonationBlock\Strauss\Stripe\Util\RequestOptions $opts the special modifiers of the request
     *
     * @return \GiveDonationBlock\Strauss\Stripe\Collection of ApiResources
     */
    public function requestCollection($method, $path, $params, $opts)
    {
        ...
        if (!($obj instanceof \Stripe\Collection)) {
            ...
            throw new \GiveDonationBlock\Strauss\Stripe\Exception\UnexpectedValueException($msg);
        }
    ...
    /**
     * @param \GiveDonationBlock\Strauss\Stripe\Util\RequestOptions $opts
     *
     * @throws \GiveDonationBlock\Strauss\Stripe\Exception\AuthenticationException
     *
     * @return string
     */
    private function apiKeyForRequest($opts)
    {
        ...
        if (null === $apiKey) {
            ...
            throw new \GiveDonationBlock\Strauss\Stripe\Exception\AuthenticationException($msg);
        }
     ...
     *
     * @throws \GiveDonationBlock\Strauss\Stripe\Exception\InvalidArgumentException
     */
    private function validateConfig($config)
    {
        // api_key
        if (null !== $config['api_key'] && !\is_string($config['api_key'])) {
            throw new \GiveDonationBlock\Strauss\Stripe\Exception\InvalidArgumentException('api_key must be null or a string');
        }

        if (null !== $config['api_key'] && ('' === $config['api_key'])) {
            $msg = 'api_key cannot be the empty string';

            throw new \GiveDonationBlock\Strauss\Stripe\Exception\InvalidArgumentException($msg);
        }
        ...
        if (null !== $config['client_id'] && !\is_string($config['client_id'])) {
            throw new \GiveDonationBlock\Strauss\Stripe\Exception\InvalidArgumentException('client_id must be null or a string');
        }

        // stripe_account
        if (null !== $config['stripe_account'] && !\is_string($config['stripe_account'])) {
            throw new \GiveDonationBlock\Strauss\Stripe\Exception\InvalidArgumentException('stripe_account must be null or a string');
        }

        // stripe_version
        if (null !== $config['stripe_version'] && !\is_string($config['stripe_version'])) {
            throw new \GiveDonationBlock\Strauss\Stripe\Exception\InvalidArgumentException('stripe_version must be null or a string');
        }

        // api_base
        if (!\is_string($config['api_base'])) {
            throw new \GiveDonationBlock\Strauss\Stripe\Exception\InvalidArgumentException('api_base must be a string');
        }

        // connect_base
        if (!\is_string($config['connect_base'])) {
            throw new \GiveDonationBlock\Strauss\Stripe\Exception\InvalidArgumentException('connect_base must be a string');
        }

        // files_base
        if (!\is_string($config['files_base'])) {
            throw new \GiveDonationBlock\Strauss\Stripe\Exception\InvalidArgumentException('files_base must be a string');
        }
        ...
        if (!empty($extraConfigKeys)) {
            ...
            throw new \GiveDonationBlock\Strauss\Stripe\Exception\InvalidArgumentException('Found unknown key(s) in configuration array: ' . $invalidKeys);
        }
    }
}
