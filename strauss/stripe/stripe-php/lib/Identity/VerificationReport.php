 ...
 * @property \GiveDonationBlock\Strauss\Stripe\StripeObject $document Result from a document check
 * @property \GiveDonationBlock\Strauss\Stripe\StripeObject $id_number Result from an id_number check
 * @property bool $livemode Has the value <code>true</code> if the object exists in live mode or the value <code>false</code> if the object exists in test mode.
 * @property \GiveDonationBlock\Strauss\Stripe\StripeObject $options
 * @property \GiveDonationBlock\Strauss\Stripe\StripeObject $selfie Result from a selfie check
 ...
 */
class VerificationReport extends \GiveDonationBlock\Strauss\Stripe\ApiResource
{
