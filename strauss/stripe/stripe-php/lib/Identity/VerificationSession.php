...
namespace GiveDonationBlock\Strauss\Stripe\Identity;
 ...
 * @property null|\GiveDonationBlock\Strauss\Stripe\StripeObject $last_error If present, this property tells you the last error encountered when processing the verification.
 * @property null|string|\GiveDonationBlock\Strauss\Stripe\Identity\VerificationReport $last_verification_report ID of the most recent VerificationReport. <a href="https://stripe.com/docs/identity/verification-sessions#results">Learn more about accessing detailed verification results.</a>
 ...
 * @property \GiveDonationBlock\Strauss\Stripe\StripeObject $options
 * @property null|\GiveDonationBlock\Strauss\Stripe\StripeObject $redaction Redaction status of this VerificationSession. If the VerificationSession is not redacted, this field will be null.
 ...
 * @property null|\GiveDonationBlock\Strauss\Stripe\StripeObject $verified_outputs The user’s verified data.
 *
 * @license MIT
 * Modified by Jason Adams on 03-March-2022 using Strauss.
 * @see https://github.com/BrianHenryIE/strauss
 */
class VerificationSession extends \GiveDonationBlock\Strauss\Stripe\ApiResource
{
     ...
     *
     * @return \GiveDonationBlock\Strauss\Stripe\Identity\VerificationSession the canceled verification session
     */
     ...
     * @throws \GiveDonationBlock\Strauss\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \GiveDonationBlock\Strauss\Stripe\Identity\VerificationSession the redacted verification session
     */
