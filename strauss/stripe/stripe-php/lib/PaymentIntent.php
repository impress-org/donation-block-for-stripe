 ...
 * @property null|string|\GiveDonationBlock\Strauss\Stripe\StripeObject $application ID of the Connect application that created the PaymentIntent.
 ...
 * @property null|\GiveDonationBlock\Strauss\Stripe\StripeObject $automatic_payment_methods Settings to configure compatible payment methods from the <a href="https://dashboard.stripe.com/settings/payment_methods">Stripe Dashboard</a>
 ...
 * @property \GiveDonationBlock\Strauss\Stripe\Collection $charges Charges that were created by this PaymentIntent, if any.
 ...
 * @property null|string|\GiveDonationBlock\Strauss\Stripe\Invoice $invoice ID of the invoice that created this PaymentIntent, if it exists.
 * @property null|\GiveDonationBlock\Strauss\Stripe\ErrorObject $last_payment_error The payment error encountered in the previous PaymentIntent confirmation. It will be cleared if the PaymentIntent is later updated for any reason.
 ...
 * @property null|\GiveDonationBlock\Strauss\Stripe\StripeObject $next_action If present, this property tells you what actions you need to take in order for your customer to fulfill a payment using the provided source.
 * @property null|string|\GiveDonationBlock\Strauss\Stripe\Account $on_behalf_of The account (if any) for which the funds of the PaymentIntent are intended. See the PaymentIntents <a href="https://stripe.com/docs/payments/connected-accounts">use case for connected accounts</a> for details.
 * @property null|string|\GiveDonationBlock\Strauss\Stripe\PaymentMethod $payment_method ID of the payment method used in this PaymentIntent.
 * @property null|\GiveDonationBlock\Strauss\Stripe\StripeObject $payment_method_options Payment-method-specific configuration for this PaymentIntent.
 * @property string[] $payment_method_types The list of payment method types (e.g. card) that this PaymentIntent is allowed to use.
 * @property null|\GiveDonationBlock\Strauss\Stripe\StripeObject $processing If present, this property tells you about the processing state of the payment.
 ...
 * @property null|string|\GiveDonationBlock\Strauss\Stripe\Review $review ID of the review associated with this PaymentIntent, if any.
 ...
 * @property null|\GiveDonationBlock\Strauss\Stripe\StripeObject $shipping Shipping information for this PaymentIntent.
 * @property null|string|\GiveDonationBlock\Strauss\Stripe\Account|\GiveDonationBlock\Strauss\Stripe\AlipayAccount|\GiveDonationBlock\Strauss\Stripe\BankAccount|\GiveDonationBlock\Strauss\Stripe\BitcoinReceiver|\GiveDonationBlock\Strauss\Stripe\Card|\GiveDonationBlock\Strauss\Stripe\Source $source This is a legacy field that will be removed in the future. It is the ID of the Source object that is associated with this PaymentIntent, if one was supplied.
 ...
 * @property null|\GiveDonationBlock\Strauss\Stripe\StripeObject $transfer_data The data with which to automatically create a Transfer when the payment is finalized. See the PaymentIntents <a href="https://stripe.com/docs/payments/connected-accounts">use case for connected accounts</a> for details.
...
class PaymentIntent extends ApiResource
{
     ...
     *
     * @return \GiveDonationBlock\Strauss\Stripe\PaymentIntent the canceled payment intent
     */
     ...
     * @throws \GiveDonationBlock\Strauss\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \GiveDonationBlock\Strauss\Stripe\PaymentIntent the captured payment intent
     */
     ...
     * @throws \GiveDonationBlock\Strauss\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \GiveDonationBlock\Strauss\Stripe\PaymentIntent the confirmed payment intent
     */
