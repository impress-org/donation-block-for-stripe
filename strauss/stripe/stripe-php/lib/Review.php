 ...
 * @property null|string|\GiveDonationBlock\Strauss\Stripe\Charge $charge The charge associated with this review.
 ...
 * @property null|\GiveDonationBlock\Strauss\Stripe\StripeObject $ip_address_location Information related to the location of the payment. Note that this information is an approximation and attempts to locate the nearest population center - it should not be used to determine a specific address.
 ...
 * @property string|\GiveDonationBlock\Strauss\Stripe\PaymentIntent $payment_intent The PaymentIntent ID associated with this review, if one exists.
 ...
 * @property null|\GiveDonationBlock\Strauss\Stripe\StripeObject $session Information related to the browsing session of the user who initiated the payment.
 *
 * @license MIT
...
class Review extends ApiResource
{
     ...
     *
     * @return \GiveDonationBlock\Strauss\Stripe\Review the approved review
     */
