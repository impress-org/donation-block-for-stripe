 ...
 * @property null|string|\GiveDonationBlock\Strauss\Stripe\BalanceTransaction $balance_transaction Balance transaction that describes the impact of this transfer on your account balance.
 ...
 * @property null|string|\GiveDonationBlock\Strauss\Stripe\Account $destination ID of the Stripe account the transfer was sent to.
 * @property string|\GiveDonationBlock\Strauss\Stripe\Charge $destination_payment If the destination is a Stripe account, this will be the ID of the payment that the destination account received for the transfer.
 ...
 * @property \GiveDonationBlock\Strauss\Stripe\Collection $reversals A list of reversals that have been applied to the transfer.
 ...
 * @property null|string|\GiveDonationBlock\Strauss\Stripe\Charge $source_transaction ID of the charge or payment that was used to fund the transfer. If null, the transfer was funded from the available balance.
...
class Transfer extends ApiResource
{
     ...
     *
     * @return \GiveDonationBlock\Strauss\Stripe\Transfer the canceled transfer
     */
     ...
     * @throws \GiveDonationBlock\Strauss\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \GiveDonationBlock\Strauss\Stripe\Collection the list of transfer reversals
     */
     ...
     * @throws \GiveDonationBlock\Strauss\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \GiveDonationBlock\Strauss\Stripe\TransferReversal
     */
