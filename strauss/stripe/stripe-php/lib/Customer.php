 ...
 * @property null|\GiveDonationBlock\Strauss\Stripe\StripeObject $address The customer's address.
 ...
 * @property null|string|\GiveDonationBlock\Strauss\Stripe\Account|\GiveDonationBlock\Strauss\Stripe\AlipayAccount|\GiveDonationBlock\Strauss\Stripe\BankAccount|\GiveDonationBlock\Strauss\Stripe\BitcoinReceiver|\GiveDonationBlock\Strauss\Stripe\Card|\GiveDonationBlock\Strauss\Stripe\Source $default_source <p>ID of the default payment source for the customer.</p><p>If you are using payment methods created via the PaymentMethods API, see the <a href="https://stripe.com/docs/api/customers/object#customer_object-invoice_settings-default_payment_method">invoice_settings.default_payment_method</a> field instead.</p>
 ...
 * @property null|\GiveDonationBlock\Strauss\Stripe\Discount $discount Describes the current discount active on the customer, if there is one.
 ...
 * @property \GiveDonationBlock\Strauss\Stripe\StripeObject $invoice_settings
 ...
 * @property null|\GiveDonationBlock\Strauss\Stripe\StripeObject $shipping Mailing and shipping address for the customer. Appears on invoices emailed to this customer.
 * @property \GiveDonationBlock\Strauss\Stripe\Collection $sources The customer's payment sources, if any.
 * @property \GiveDonationBlock\Strauss\Stripe\Collection $subscriptions The customer's current subscriptions, if any.
 * @property \GiveDonationBlock\Strauss\Stripe\StripeObject $tax
 ...
 * @property \GiveDonationBlock\Strauss\Stripe\Collection $tax_ids The customer's tax IDs.
 *
 * @license MIT
...
class Customer extends ApiResource
{
     ...
     *
     * @return \GiveDonationBlock\Strauss\Stripe\Customer the updated customer
     */
     ...
     *
     * @return \GiveDonationBlock\Strauss\Stripe\Collection list of PaymentMethods
     */
     ...
     * @throws \GiveDonationBlock\Strauss\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \GiveDonationBlock\Strauss\Stripe\Collection the list of customer balance transactions
     */
     ...
     * @throws \GiveDonationBlock\Strauss\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \GiveDonationBlock\Strauss\Stripe\CustomerBalanceTransaction
     */
     ...
     * @throws \GiveDonationBlock\Strauss\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \GiveDonationBlock\Strauss\Stripe\Collection the list of payment sources (AlipayAccount, BankAccount, BitcoinReceiver, Card or Source)
     */
     ...
     * @throws \GiveDonationBlock\Strauss\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \GiveDonationBlock\Strauss\Stripe\AlipayAccount|\GiveDonationBlock\Strauss\Stripe\BankAccount|\GiveDonationBlock\Strauss\Stripe\BitcoinReceiver|\GiveDonationBlock\Strauss\Stripe\Card|\GiveDonationBlock\Strauss\Stripe\Source
     */
     ...
     * @throws \GiveDonationBlock\Strauss\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \GiveDonationBlock\Strauss\Stripe\Collection the list of tax ids
     */
     ...
     * @throws \GiveDonationBlock\Strauss\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \GiveDonationBlock\Strauss\Stripe\TaxId
     */
