 ...
 * @property \GiveDonationBlock\Strauss\Stripe\StripeObject $supported_bank_account_currencies Currencies that can be accepted in the specific country (for transfers).
 ...
 * @property \GiveDonationBlock\Strauss\Stripe\StripeObject $verification_fields
 *
 * @license MIT
