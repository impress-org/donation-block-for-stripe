 ...
 * @property \GiveDonationBlock\Strauss\Stripe\StripeObject $computed
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property null|string $currency Three-letter <a href="https://www.iso.org/iso-4217-currency-codes.html">ISO currency code</a>, in lowercase. Must be a <a href="https://stripe.com/docs/currencies">supported currency</a>.
 * @property null|string|\GiveDonationBlock\Strauss\Stripe\Customer $customer The customer which this quote belongs to. A customer is required before finalizing the quote. Once specified, it cannot be changed.
 * @property (string|\GiveDonationBlock\Strauss\Stripe\TaxRate)[] $default_tax_rates The tax rates applied to this quote.
 * @property null|string $description A description that will be displayed on the quote PDF.
 * @property (string|\GiveDonationBlock\Strauss\Stripe\Discount)[] $discounts The discounts applied to this quote.
 ...
 * @property null|\GiveDonationBlock\Strauss\Stripe\StripeObject $from_quote Details of the quote that was cloned. See the <a href="https://stripe.com/docs/quotes/clone">cloning documentation</a> for more details.
 * @property null|string $header A header that will be displayed on the quote PDF.
 * @property null|string|\GiveDonationBlock\Strauss\Stripe\Invoice $invoice The invoice that was created from this quote.
 * @property null|\GiveDonationBlock\Strauss\Stripe\StripeObject $invoice_settings All invoices will be billed using the specified settings.
 * @property \GiveDonationBlock\Strauss\Stripe\Collection $line_items A list of items the customer is being quoted for.
 ...
 * @property null|string|\GiveDonationBlock\Strauss\Stripe\Account $on_behalf_of The account on behalf of which to charge. See the <a href="https://support.stripe.com/questions/sending-invoices-on-behalf-of-connected-accounts">Connect documentation</a> for details.
 * @property string $status The status of the quote.
 * @property \GiveDonationBlock\Strauss\Stripe\StripeObject $status_transitions
 * @property null|string|\GiveDonationBlock\Strauss\Stripe\Subscription $subscription The subscription that was created or updated from this quote.
 * @property \GiveDonationBlock\Strauss\Stripe\StripeObject $subscription_data
 * @property null|string|\GiveDonationBlock\Strauss\Stripe\SubscriptionSchedule $subscription_schedule The subscription schedule that was created or updated from this quote.
 * @property \GiveDonationBlock\Strauss\Stripe\StripeObject $total_details
 * @property null|\GiveDonationBlock\Strauss\Stripe\StripeObject $transfer_data The account (if any) the payments will be attributed to for tax reporting, and where funds from each payment will be transferred to for each of the invoices.
 *
 * @license MIT
...
class Quote extends ApiResource
{
     ...
     * @throws \GiveDonationBlock\Strauss\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \GiveDonationBlock\Strauss\Stripe\Quote the accepted quote
     */
     ...
     * @throws \GiveDonationBlock\Strauss\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \GiveDonationBlock\Strauss\Stripe\Quote the canceled quote
     */
     ...
     * @throws \GiveDonationBlock\Strauss\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \GiveDonationBlock\Strauss\Stripe\Quote the finalized quote
     */
     ...
     * @throws \GiveDonationBlock\Strauss\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \GiveDonationBlock\Strauss\Stripe\Collection list of LineItems
     */
