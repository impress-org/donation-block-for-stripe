 ...
 * @property null|\GiveDonationBlock\Strauss\Stripe\StripeObject $address_kana The Kana variation of the person's address (Japan only).
 * @property null|\GiveDonationBlock\Strauss\Stripe\StripeObject $address_kanji The Kanji variation of the person's address (Japan only).
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property \GiveDonationBlock\Strauss\Stripe\StripeObject $dob
 ...
 * @property null|\GiveDonationBlock\Strauss\Stripe\StripeObject $future_requirements Information about the upcoming new requirements for this person, including what information needs to be collected, and by when.
 ...
 * @property \GiveDonationBlock\Strauss\Stripe\StripeObject $relationship
 * @property null|\GiveDonationBlock\Strauss\Stripe\StripeObject $requirements Information about the requirements for this person, including what information needs to be collected, and by when.
 ...
 * @property \GiveDonationBlock\Strauss\Stripe\StripeObject $verification
 *
 * @license MIT
...
class Person extends ApiResource
{
     ...
     *
     * @throws \GiveDonationBlock\Strauss\Stripe\Exception\BadMethodCallException
     */
