 ...
 * @property \GiveDonationBlock\Strauss\Stripe\BalanceTransaction[] $balance_transactions List of zero, one, or two balance transactions that show funds withdrawn and reinstated to your Stripe account as a result of this dispute.
 * @property string|\GiveDonationBlock\Strauss\Stripe\Charge $charge ID of the charge that was disputed.
 ...
 * @property \GiveDonationBlock\Strauss\Stripe\StripeObject $evidence_details
 ...
 * @property null|string|\GiveDonationBlock\Strauss\Stripe\PaymentIntent $payment_intent ID of the PaymentIntent that was disputed.
...
class Dispute extends ApiResource
{
     ...
     *
     * @return \GiveDonationBlock\Strauss\Stripe\Dispute the closed dispute
     */
