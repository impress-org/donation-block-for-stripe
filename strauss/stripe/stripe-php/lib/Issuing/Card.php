 ...
 * @property null|string|\GiveDonationBlock\Strauss\Stripe\Issuing\Card $replaced_by The latest card that replaces this card, if any.
 * @property null|string|\GiveDonationBlock\Strauss\Stripe\Issuing\Card $replacement_for The card this card replaces, if any.
 * @property null|string $replacement_reason The reason why the previous card needed to be replaced.
 * @property null|\GiveDonationBlock\Strauss\Stripe\StripeObject $shipping Where and how the card will be shipped.
 * @property \GiveDonationBlock\Strauss\Stripe\StripeObject $spending_controls
 * @property string $status Whether authorizations can be approved on this card.
 * @property string $type The type of the card.
 * @property null|\GiveDonationBlock\Strauss\Stripe\StripeObject $wallets Information relating to digital wallets (like Apple Pay and Google Pay).
 *
 * @license MIT
 * Modified by Jason Adams on 03-March-2022 using Strauss.
 * @see https://github.com/BrianHenryIE/strauss
 */
class Card extends \GiveDonationBlock\Strauss\Stripe\ApiResource
{
     ...
     *
     * @return \GiveDonationBlock\Strauss\Stripe\Issuing\CardDetails the card details associated with that issuing card
     */
