...
use GiveDonationBlock\Strauss\Stripe\Exception;
use GiveDonationBlock\Strauss\Stripe\Stripe;
use GiveDonationBlock\Strauss\Stripe\Util;
...
class CurlClient implements ClientInterface, StreamingClientInterface
{
    ...
    /** @var \GiveDonationBlock\Strauss\Stripe\Util\RandomGenerator */
     ...
     * @param null|\GiveDonationBlock\Strauss\Stripe\Util\RandomGenerator $randomGenerator
     */
     ...
     * @param int $errno
     * @param int $rcode
     * @param array|\GiveDonationBlock\Strauss\Stripe\Util\CaseInsensitiveArray $rheaders
     * @param int $numRetries
     *
     * @return bool
     */
