 ...
 * @property \GiveDonationBlock\Strauss\Stripe\StripeObject $after_completion
 ...
 * @property \GiveDonationBlock\Strauss\Stripe\Collection $line_items The line items representing what is being sold.
 ...
 * @property null|\GiveDonationBlock\Strauss\Stripe\StripeObject $shipping_address_collection Configuration for collecting the customer's shipping address.
 * @property null|\GiveDonationBlock\Strauss\Stripe\StripeObject $subscription_data When creating a subscription, the specified configuration data will be used. There must be at least one line item with a recurring price to use <code>subscription_data</code>.
 * @property null|\GiveDonationBlock\Strauss\Stripe\StripeObject $transfer_data The account (if any) the payments will be attributed to for tax reporting, and where funds from each payment will be transferred to.
