...
use GiveDonationBlock\Strauss\Stripe\StripeObject;
...
abstract class Util
{
    ...
    {
        $types = \GiveDonationBlock\Strauss\Stripe\Util\ObjectTypes::mapping;
        if (self::isList($resp)) {
            $mapped = [];
            foreach ($resp as $i) {
        ...
        if (\is_array($resp)) {
            if (isset($resp['object']) && \is_string($resp['object']) && isset($types[$resp['object']])) {
                ...
                $class = \GiveDonationBlock\Strauss\Stripe\StripeObject::class;
            }
