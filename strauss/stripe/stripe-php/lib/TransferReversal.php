 ...
 * @property null|string|\GiveDonationBlock\Strauss\Stripe\Refund $destination_payment_refund Linked payment refund for the transfer reversal.
 ...
 * @property null|string|\GiveDonationBlock\Strauss\Stripe\Refund $source_refund ID of the refund responsible for the transfer reversal.
 * @property string|\GiveDonationBlock\Strauss\Stripe\Transfer $transfer ID of the transfer that was reversed.
 *
 * @license MIT
