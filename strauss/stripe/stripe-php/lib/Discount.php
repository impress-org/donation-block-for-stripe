 ...
 * @property \GiveDonationBlock\Strauss\Stripe\Coupon $coupon Hash describing the coupon applied to create this discount.
 * @property string|\GiveDonationBlock\Strauss\Stripe\Customer $customer The ID of the customer associated with this discount.
