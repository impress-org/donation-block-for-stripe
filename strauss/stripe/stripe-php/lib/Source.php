 ...
 * @property \GiveDonationBlock\Strauss\Stripe\StripeObject $ach_debit
 ...
 * @property \GiveDonationBlock\Strauss\Stripe\StripeObject $code_verification
 ...
 * @property \GiveDonationBlock\Strauss\Stripe\StripeObject $multibanco
 * @property null|\GiveDonationBlock\Strauss\Stripe\StripeObject $owner Information about the owner of the payment instrument that may be used or required by particular source types.
 * @property \GiveDonationBlock\Strauss\Stripe\StripeObject $p24
 * @property \GiveDonationBlock\Strauss\Stripe\StripeObject $receiver
 * @property \GiveDonationBlock\Strauss\Stripe\StripeObject $redirect
 * @property \GiveDonationBlock\Strauss\Stripe\StripeObject $sepa_credit_transfer
 ...
 * @property \GiveDonationBlock\Strauss\Stripe\StripeObject $source_order
 ...
 * @property \GiveDonationBlock\Strauss\Stripe\StripeObject $three_d_secure
 ...
 * @property \GiveDonationBlock\Strauss\Stripe\StripeObject $wechat
 *
 * @license MIT
...
class Source extends ApiResource
{
     ...
     *
     * @throws \GiveDonationBlock\Strauss\Stripe\Exception\UnexpectedValueException if the source is not attached to a customer
     * @throws \GiveDonationBlock\Strauss\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \GiveDonationBlock\Strauss\Stripe\Source the detached source
     */
     ...
     * @throws \GiveDonationBlock\Strauss\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \GiveDonationBlock\Strauss\Stripe\Collection the list of source transactions
     */
    public function sourceTransactions($params = null, $opts = null)
    {
        $url = $this->instanceUrl() . '/source_transactions';
        list($response, $opts) = $this->_request('get', $url, $params, $opts);
        $obj = \GiveDonationBlock\Strauss\Stripe\Util\Util::convertToStripeObject($response, $opts);
     ...
     * @throws \GiveDonationBlock\Strauss\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \GiveDonationBlock\Strauss\Stripe\Source the verified source
     */
