 ...
 * @property \GiveDonationBlock\Strauss\Stripe\Coupon $coupon A coupon contains information about a percent-off or amount-off discount you might want to apply to a customer. Coupons may be applied to <a href="https://stripe.com/docs/api#invoices">invoices</a> or <a href="https://stripe.com/docs/api#create_order_legacy-coupon">orders</a>. Coupons do not work with conventional one-off <a href="https://stripe.com/docs/api#create_charge">charges</a>.
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property null|string|\GiveDonationBlock\Strauss\Stripe\Customer $customer The customer that this promotion code can be used by.
 ...
 * @property \GiveDonationBlock\Strauss\Stripe\StripeObject $restrictions
